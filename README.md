...
| SIDECAR_MODULE_HEALTH_PATH_PREFIX_ENABLED      | false                                                                                                                                                                                                                                                                 |   false    | Defines if module health path prefix is enabled for routing or not.                                                                                             |
...
| SC_ACCESS_LOG_FORMAT                           | %X{remote-ip} - %X{remote-host} - %X{remote-user} [%d{dd/MM/yyyy:HH:mm:ss z}] %X{method} %X{path} %X{protocol} %X{status} %X{bytes} rt=%X{rt}  uct=%X{uct}  uht=%X{uht}  urt=%X{urt}  %X{user-agent} %X{x-okapi-tenant} %X{x-okapi-user-id} %X{x-okapi-request-id} %n |   false    | Access log format.                                                                                                                                              |
...
| SC_TLS_SECURITY_PROVIDERS                      | BCFIPS                                                                                                                                                                                                                                                                |   false    | Security provider value                                                                                                                                         |
...
| WEB_CLIENT_TLS_TRUSTSTORE_PATH                 | -                                                                                                                                                                                                                                                                     |   false    | Truststore file path for web client.                                                                                                                            |
| WEB_CLIENT_TLS_TRUSTSTORE_PASSWORD             | -                                                                                                                                                                                                                                                                     |   false    | Truststore password for web client.                                                                                                                             |
...
| ENTITLEMENT_TLS_KEYSTORE_PASSWORD              | -                                                                                                                                                                                                                                                                     |   false    | Keystore password for Entitlement consumer.                                                                                                                     |
