...
| ROOT_LOG_LEVEL                                      | INFO                                                                                                                                                                                                                                                                   |  false   | Root log level.                                                                                                                                               |
| CLOUDWATCH_ENABLED                                  | false                                                                                                                                                                                                                                                                  |  false   | Set to true to enable logging to Cloudwatch                                                                                                                   |
| CLOUDWATCH_ACCESS_KEY                               | -                                                                                                                                                                                                                                                                      |  false   | The AWS access key.                                                                                                                                           |
| CLOUDWATCH_SECRET                                   | -                                                                                                                                                                                                                                                                      |  false   | The AWS secret for the key.                                                                                                                                   |
...
| ROOT_LOG_LEVEL                               | INFO                                |  false   | Root log level.                                                                                                                                               |
| REQUEST_TIMEOUT                              | 60000                               |  false   | Configures the amount of time in milliseconds after which if the request does not return any data within the timeout period fails the request.                |
| WEB_CLIENT_TLS_PORT                          | 8443                                |  false   | Web client port for https connection.                                                                                                                         |
