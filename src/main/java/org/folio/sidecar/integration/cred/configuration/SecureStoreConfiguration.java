...
public class SecureStoreConfiguration {
  ...
  public FsspConfigProperties fsspProperties() {
    return FsspConfigProperties.builder()
      ...
      .keyStorePath(getValue(FSSP_PREFIX, "key-store-path"))
      .keyStoreFileType(getValue(FSSP_PREFIX, "key-store-file-type"))
      .keyStorePassword(getValue(FSSP_PREFIX, "key-store-password"))
