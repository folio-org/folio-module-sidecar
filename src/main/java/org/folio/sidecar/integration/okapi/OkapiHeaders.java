...
/**
 * X-Okapi Headers used in the system. Some are needed by every module, and some are only used between Okapi itself and
 * the authorization/authentication modules. Also contains the ids for the built-in supertenant and Okapi's internal
 * module(s)
 */
...
public class OkapiHeaders {
  ...
  /**
   * X-System-Token. A token that is used for module to module communication.
   */
   ...
   * Defaults to {@code http://localhost:9130}
   */
   ...
   * how long did it take. For example, {@code GET sample-module-1.0.0 http://localhost:9231/testb : 204 3748us}
   */
