...
import org.folio.sidecar.it.ForwardEgressToGatewayIT.ForwardEgressToGatewayTestProfile;
...
@IntegrationTest
@TestProfile(ForwardEgressToGatewayTestProfile.class)
@EnableWireMock(verbose = true)
class ForwardEgressToGatewayIT {
  ...
  public static final class ForwardEgressToGatewayTestProfile extends CommonIntegrationTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      ...
      result.put("routing.forward-to-gateway.always", "true");
