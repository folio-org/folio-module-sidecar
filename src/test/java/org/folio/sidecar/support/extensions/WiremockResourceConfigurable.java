...
@Getter
@Log4j2
public class WiremockResourceConfigurable implements QuarkusTestResourceConfigurableLifecycleManager<EnableWireMock> {
  ...
  public Map<String, String> start() {
    serverManager.start();
    wireMockServer = serverManager.getServer();
